...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<small>Capital Share Ledger - Common </small><br /><small>Beginning - Current</small></h4>
			<hr class="thin bg-grayLighter">
...
<script type="text/javascript">
	$(function(){
		...
		$('#btnGenerateReports').click(function(){
			...
			fnGetSavingsLedgerCommon(_params);
		});
	});
	
	function fnGetSavingsLedgerCommon(_params){
		$('#borrowersname').text('');
		var req=$.ajax({
			url: '../classes/BLL/SavingsLedger_Common.php',
			method: 'post',
			datatype: 'json',
			data:{
				params:_params
