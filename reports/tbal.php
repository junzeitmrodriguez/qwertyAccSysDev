...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<h4 class="text-light text-shadow" style="padding-top: 3.125rem">DAVAO ACCOUNTANTS MULTI-PURPOSE COOPERATIVE</h4>
			<small>TRIAL BALANCE</small>
			<br /><small id="forthemonth"></small>
			<!--<h5 id="mnthyr"></h5>
			<br />
			<h5 id="entrytype"></h5>
			-->
			...
			<div class="grid">
				<div id="tbalresults" class="row cells12">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function fnGetTBal(_params){
		var req=$.ajax({
			url: '../classes/BLL/TrialBalance.php',
			method: 'post',
			datatype: 'json',
			data:{
				params:_params
