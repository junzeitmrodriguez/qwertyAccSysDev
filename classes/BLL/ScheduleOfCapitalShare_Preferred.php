...
$res= $fn->GetScheduleofCapitalShare_Prefered($params['acyear'],$params['acmonth']); 
$ret=$res->fetchAll();
...
if($ret){
	echo '<table><thead>';
	echo '<tr><td colspan=3></td><td colspan=2 align="center">This Month</td><td></td></tr>';
	...
	echo '<tr><td align="right">'.$cnt.'</td><td align="right"><strong><h4>Total</h4></strong></td><td align="right"><strong><h4>'.number_format($totallnbal,2).'</h4></strong></td><td align="right"><strong><h4>'.number_format($totaldebit,2).'</h4></strong></td>';
	if ($totalcredit<0){
